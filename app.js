(()=>{
  ...
  npcProfileCss.href='npc-profile.css?v=20260911-solid-parchment-1';
  document.head.appendChild(npcProfileCss);
  const recordProfileCss=document.createElement('link');
  recordProfileCss.rel='stylesheet';
  recordProfileCss.href='record-profile.css?v=20260911-solid-parchment-1';
  ...
  equipmentProfileCss.href='equipment-profile.css?v=20260911-solid-parchment-1';
