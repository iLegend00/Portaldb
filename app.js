(()=>{
  ...
  npcProfileCss.href='npc-profile.css?v=20260910-blue-enforcement-1';
  document.head.appendChild(npcProfileCss);
  const recordProfileCss=document.createElement('link');
  recordProfileCss.rel='stylesheet';
  recordProfileCss.href='record-profile.css?v=20260910-blue-enforcement-1';
  ...
  equipmentProfileCss.href='equipment-profile.css?v=20260910-blue-enforcement-1';
  ...
  document.write('<script src="verification.js?v=20260828-two-state-provenance-1"><\/script><script src="npc-art.js?v=20260819-all-npcs-1"><\/script><script src="app-core.js?v=20260909-race-fix-1"><\/script>');
})();
